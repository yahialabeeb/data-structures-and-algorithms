...
const checkValues = (obj, value) => {
  ...
  let value2 = valueArray.includes(value) 
    return value2
};
...
const updateNumbers = (obj) => {
  ...
  Object.entries(obj).forEach(entry => {
    let joined = entry[0]+': '+entry[1]
    joinedArr.push(joined)
  })
  return joinedArr
};
...
const hasChildrenValues = (arr, character) => {
  ...
  let objectt = arr.find((obj) => {
    return obj.name === character
  })
  let arrayy = Object.values(objectt)
