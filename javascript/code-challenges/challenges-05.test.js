...
const addValues = (arr) => {
  const added = arr.reduce( (accumulator, val) => {
...
const addPurchases = (arr) => {
  const Purchases = arr.reduce( (accumulator, val) => {
...
const countNumberOfElements = (arr) => {
  const NumberOfElements = arr.reduce( (accumulator, val) => {
    accumulator++ 
    return accumulator 
  }, 0);
...
const returnNames = (arr) => {
  const names = arr.reduce( (namesarr, val) => {
...
const reversedString = (str) => {
  ...
  const reversed = strarr.reduce( (caompp, val) => {
    caompp = val + caompp 
    return  caompp
  }, "");
  return reversed
