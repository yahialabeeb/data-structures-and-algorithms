...
const sortStarWarsCharacters = (starWarsArr) => {
  starWarsPeople.sort(function (a, b) { return a.height - b.height });
  return starWarsPeople.reverse()
}
...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach(element => {
    ...
    let arr1 = element.slice(element.indexOf(' ') + 1)
    let arr2 = arr1.slice(arr1.indexOf(' ') + 1)
    result.push(arr2)
  })
